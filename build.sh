...
$CONDA_ENV_PATH/bin/python update_static_versions.py "templates/oa/work-summary.html" ${VERSION}
$CONDA_ENV_PATH/bin/python update_static_versions.py "templates/oa/announcement.html" ${VERSION}
